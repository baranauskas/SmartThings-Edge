...
--local cap = {}
--cap.sunPosition = capabilities[ config.myCapabilities .. ".sunPosition"]
--cap.percentage  = capabilities[ config.myCapabilities .. ".percentage"]

local function loadCapabilities( names )
  local cap = {}
  for i = 1, #(names) do
    cap[ names[i] ] = capabilities[ config.myCapabilities .. "." .. names[i] ]
  end
  return cap
end
